...
PYTHON_GETPATH_CFLAGS = -DPYTHONPATH='":/usr/lib/python2.7:/usr/lib/python2.7/plat-linux2:/usr/lib/python2.7/lib-tk:/usr/lib/python2.7/lib-old:/usr/lib/python2.7/lib-dynload:/usr/local/lib/python2.7/dist-packages:/usr/lib/python2.7/dist-packages:/usr/lib/pymodules/python2.7"' -DPREFIX='"/usr"' -DEXEC_PREFIX='"/usr"'
...
RUBY_CFLAGS	= -I/usr/lib/ruby/1.8/x86_64-linux -DRUBY_VERSION=18
RUBY_LIBS	= -lruby1.8 -lpthread -lrt -ldl -lcrypt -lm  -L/usr/lib
